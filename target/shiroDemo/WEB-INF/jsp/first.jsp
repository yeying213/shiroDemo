...
<head>
	...
	<LINK rel="stylesheet" type="text/css" href="${resourceRoot}/js/easyui/styles/default.css">
	...
	<SCRIPT type="text/javascript">
		...
		$(function() {//预加载方法
			...
			$('#tabs').tabs('add', {
				title : '欢迎使用',
				content : createFrame('${baseurl}welcome.jsp')  //点击左边导航栏直接在右边打开标签
			}).tabs({
...
<DIV
		style='background: url("${resourceRoot}/images/layout-browser-hd-bg.gif")
				repeat-x center 50% rgb(127, 153, 190); height: 30px; color: rgb(255, 255, 255);
				line-height: 20px; overflow: hidden; font-family: Verdana, 微软雅黑, 黑体;'
		...
		align="absmiddle" src="${resourceRoot}/images/blocks.gif" width="20" height="20">
